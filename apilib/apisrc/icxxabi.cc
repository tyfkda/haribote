// Global finalizer for C++
// ref: http://wiki.osdev.org/C_PlusPlus
// ref: http://wiki.osdev.org/Calling_Global_Constructors
...
void *__dso_handle; //Attention! Optimally, you should remove the '= 0' part and define this in your asm script.
...
void __cxa_finalize(void *f) {
  if (!f) {
    ...
    //is CRITICAL!
    for (int i = __atexit_func_count; i-- > 0; ) {
